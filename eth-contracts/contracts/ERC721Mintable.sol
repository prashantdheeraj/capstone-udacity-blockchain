...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused {
        require(!_paused, "Contract Status: Paused");
        _;
    }

    modifier paused {
        require(_paused, "Contract status: Live");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "Owner owns this token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
          require( msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender),
            "The owner or a designate can perform this function");
    ...
    function getApproved(uint256 tokenId) public view returns (address approvedAddress) {
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Caller is not the owner");
        ...
        _ownedTokensCount[from].decrement(); //DEbit First
        _ownedTokensCount[to].increment();  //Credit later
        _tokenOwner[tokenId] = to; //Change the ownership
